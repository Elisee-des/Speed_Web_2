...
@section('titre', "Ajoute d'une nouveau gestionnaire")
...
<nav style="--bs-breadcrumb-divider: '>'" aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item">
            <a href="{{route('gestionnaire.delegues.index')}}">Liste des gestionnaires</a>
        </li>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card mb-2">
                        ...
                        <div class="card-body">
                            {{-- <input type="text" disabled class="form-control"
                                value="{{Auth::user()->filiere->sigle}}" placeholder="Elle sera mise automatiquement">
                            --}}
                            <select name="filiere_id" class="form-select" id="choices-publish-visibility-input" data-choices
                ...
                <div class="col-lg-8 mb-2">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Informations du gestionnaire</h5>
                        </div>
                        <div class="card-body">
                            <div class="mb-0 nom-affiche">
                                ...
                                <input type="text" name="nom_prenom" class="form-control"
                                    placeholder="Ouedraogo Alassane" id="recipient-name">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="email" name="email" class="form-control"
                                    placeholder="Exple: alassane@gmail.com" id="recipient-name">
                                @if ($errors->has('email'))
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" name="password" class="form-control"
                                    placeholder="Choisez un mot de passe assez securisé" id="recipient-name">
