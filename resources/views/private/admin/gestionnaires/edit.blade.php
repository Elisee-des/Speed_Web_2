...
@section('titre', "Edition du délégué $delegue->nom_prenom")
...
<div class="container-content">
    <div class="container-content">
        <h2 class="mb-4 title-header" style="text-align: center;, margin-bottom:10px;">
            Enregistré le délégué {{$delegue->nom_prenom}}
        </h2>

        <form action="{{route('admin.gestionnaire.delegues.update', $delegue->id)}}" method="post">
            @csrf
          @method("PATCH")
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card mb-2">
                        <div class="card-header">
                            <h5 class="card-title mb-0">Rôle</h5>
                        </div>
                        <!-- end card body -->
                        <div class="card-body">
                            <select name="role" class="form-select" id="categorie-select">
                                {{-- <option value="{{$delegue->role}}" selected>{{$delegue->role}}</option> --}}
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-0 nom-affiche">
                                ...
                                <input type="text" name="nom_prenom" value="{{$delegue->nom_prenom}}" class="form-control" placeholder="Ouedraogo Alassane"
                                    id="recipient-name">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="email" name="email" value="{{$delegue->email}}" class="form-control" placeholder="Exple: alassane@gmail.com"
                                    id="recipient-name">
                                @if ($errors->has('email'))
            ...
            <div class="mt-2 mb-3 cnt-file " style="gap: 3px">
                <button type="submit" style="gap: 3" class="submit-file">
                    <i class="fa-solid fa-save" style="color: #feffff;"></i>
                    Sauvegarder
                </button>
