            ...
            <table class="table table-bordered table-container-elements">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="{{route('delegue.resultats.show', $resultat->id)}}" title="Cliquez pour voir les details">{{$resultat->nom_module}}</a></td>
                        <td><a href="{{route('delegue.resultats.show', $resultat->id)}}" title="Cliquez pour voir les details">{{count($resultat->images)}}</a></td>
                        <td><a href="{{route('delegue.resultats.show', $resultat->id)}}" title="Cliquez pour voir les details">{{$resultat->created_at->format('d/m/y')}}</a></td>
                    </tr>
