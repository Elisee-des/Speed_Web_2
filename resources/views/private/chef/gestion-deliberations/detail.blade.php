...
@section('titre', "Gestion des délibérations")
...
<nav style="--bs-breadcrumb-divider: '>'" aria-label="breadcrumb">
    <ol class="breadcrumb">
        <li class="breadcrumb-item">
            <a href="{{route('delegue.deliberations.index')}}">Gestion des délibérations</a>
        </li>
...
<div class="container-content">
    <h2 class="title-header" style="text-align: center;, margin-bottom:10px;">
        Detail des délibérations de {{$deliberation->nom_module}}
    </h2>
    ...
    <div class="">
        <table class="table table-container-elements">
            ...
            <tbody>
                <tr>
                    <td>{{count($deliberation->images)}}</td>
                    <td>{{$deliberation->created_at->format('d/m/y')}}</td>
                    <td>
                        <a href='#' class="btn btn-outline-primary" data-bs-toggle="modal"
                            data-bs-target="#exampleModalEdition" title="Cliquez ici pour modifier la délibération"><i
        ...
        <div class="d-flex align-items-center justify-content-between mb-3">
            ...
            <div class="option-detail-liste-container">
                {{-- <a href="{{route('delegue.deliberation.parametre')}}" class="btn btn-primary btn-cool"
                    title="Clique  Ici pour ajouter une nouvelle délibération."><i class="fa-solid fa-gear"
                        style="color: #feffff;"></i> Paramètre</a> --}}
                <a href="{{route('delegue.deliberations.ajout-image.action', $deliberation->id)}}"
                ...
                @if ($deliberation->actif == 0)
                <form action="{{route('delegue.deliberations.affiche', $deliberation->id)}}" method="POST">
                    @csrf
                    <a href="#" class="btn btn-primary btn-cool-2" data-bs-toggle="modal" type="submit"
                        data-bs-target="#exampleModalDeliberationAffiche"
                        title="Clique  Ici pour afficher ces délibérations."><i class="fa-solid fa-eye"></i>
                        Afficher ces images</a>
                </form>
                @else
                <form action="{{route('delegue.deliberations.cacher', $deliberation->id)}}" method="POST">
                    @csrf
                    <a href="#" class="btn btn-primary btn-cool-2" data-bs-toggle="modal" type="submit"
                        data-bs-target="#exampleModalDeliberationCache"
                        title="Clique  Ici pour cacher ces délibérations."><i class="fa-solid fa-eye"></i>
                        Cacher ces images</a>
                </form>
                @endif
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form
                                action="{{route('delegue.deliberations.suppression-image.action', [$deliberation->id, $image->id])}}"
                                method="post">
                                @csrf
                                <div class="">
            ...
            <div class="modal fade" id="exampleModalEditionImage" tabindex="-1" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form
                                action="{{route('delegue.deliberations.edition-image.action', [$deliberation->id, $image->id])}}"
        ...
        <div class="text-images-plus-delete">
            ...
            <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModalDeleteDeliberation"
                ...
                onclick="return confirm('Etes vous sûr ?')" style="font-size: 15px;"><i class="fa-solid fa-trash"
                    style="color: #feffff;"></i> Supprimer cette délibération
            </a>
        </div>
    </div>
...
{{-- Modal pour la suppression du deliberation --}}
<div class="modal fade" id="exampleModalDeleteDeliberation" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Suppression de la délibération
                    <strong>{{$deliberation->nom_module}}</strong>
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{route('delegue.deliberations.suppresion-module.action', $deliberation->id)}}"
                    method="POST">
                    @method('delete')
                    @csrf
                    <div class="">
                        <label for="recipient-name" class="col-form-label">Tout les images associés à la délibération
                            <strong>{{$deliberation->nom_module}}</strong> seront supprimées.
                        </label>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i
...
<div class="modal fade" id="exampleModalEdition" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edition de la délibération
                    <strong>{{$deliberation->nom_module}}</strong>
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{route('delegue.deliberations.edition-nom-module.action', $deliberation->id)}}"
                    method="POST">
                    @csrf
                    <div class="">
                        <label for="recipient-name" class="col-form-label">Nom du résultat</label>
                        <input type="text" name="nom_module" class="form-control" value="{{$deliberation->nom_module}}"
...
<div class="modal fade" id="exampleModalAjoutImage" tabindex="-1" aria-labelledby="exampleModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Ajout d'image à la délibération
                    <strong>{{$deliberation->nom_module}}</strong>
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{route('delegue.deliberations.ajout-image.action', $deliberation->id)}}" method="POST"
...
{{-- Modal pour la suppression du deliberation --}}
<div class="modal fade" id="exampleModalDeliberationAffiche" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Afficher la délibération
                    <strong>{{$deliberation->nom_module}}</strong>
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
                ...
                <form action="{{route('delegue.deliberations.affiche', $deliberation->id)}}" method="POST">
                    ...
                    <div class="">
                        <label for="recipient-name" class="col-form-label">Tout les images associés à
                            <strong>{{$deliberation->nom_module}}</strong> seront visible chez vos etudiants.
                        </label>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i
                                class="fa-solid fa-xmark" style="color: #feffff;"></i> Annuler</button>
                        <button type="submit" class="btn btn-primary btn-cool-dark"><i class="fa-solid fa-check"
                                style="color: #feffff;"></i>
                            Je confirme</button>
                    </div>
                </form>
...
{{-- Modal pour la suppression du deliberation --}}
<div class="modal fade" id="exampleModalDeliberationCache" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Cacher la délibération
                    <strong>{{$deliberation->nom_module}}</strong>
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
                <form action="{{route('delegue.deliberations.cacher', $deliberation->id)}}" method="POST">
                    ...
                    <div class="">
                        <label for="recipient-name" class="col-form-label">Tout les images associés à
                            <strong>{{$deliberation->nom_module}}</strong> seront cachés chez vos etudiants.
                        </label>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"><i
