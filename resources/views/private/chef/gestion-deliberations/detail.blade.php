            ...
            <table class="table table-container-elements">
                ...
                <tbody>
                    <tr>
                        ...
                        <td>12/02/2023</td>
                        <td>
                            <a href='' class="btn btn-outline-primary" data-bs-toggle="modal" title="Cliquez ici pour modifier la déliberation" data-bs-target="#exampleModalEdition"><i class="fa-solid fa-pen" style="color: #0432ff;"></i> Modifier</a>
                        </td>
                    </tr>
                </tbody>
            </table>
